  ...
  return (
    <header className="sticky top-0 z-50 bg-[#191818] flex items-center justify-between px-8 md:px-24 py-4 shadow-md">
      ...
      <nav className="flex-1">
        <ul className="flex gap-4 md:gap-6 text-sm font-semibold uppercase tracking-wide justify-start">
      ...
      <div className="flex-1 flex justify-end items-center gap-4 md:gap-6 text-md">
        ...
        <span className="hidden md:inline-block text-sm">+54 9 11 2461-1654</span>
      </div>
    </header>
  );
};
